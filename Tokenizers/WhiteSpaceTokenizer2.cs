...
{
    public class WhiteSpaceTokenizer2 : ITokenizer2/*Rôle : découper le texte en mots(tokens) selon les caractères
                                                  * non alphabétiques.
    ...
    {
        public IEnumerable<string> Tokenize2(string text)
        {
